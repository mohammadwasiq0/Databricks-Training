...
# MAGIC - Partitioning Recommendations:
...
# MAGIC [AWS](https://docs.databricks.com/aws/en/sql/language-manual/sql-ref-syntax-ddl-create-table-using) |
# MAGIC [Azure](https://learn.microsoft.com/en-us/azure/databricks/sql/language-manual/sql-ref-syntax-ddl-create-table-using) |
# MAGIC [GCP](https://docs.databricks.com/gcp/en/sql/language-manual/sql-ref-syntax-ddl-create-table-using)
# MAGIC - About ZORDER:
...
# MAGIC
# MAGIC Run the following cell to configure your working environment for this course. It will also set your perf_opt catalog to your unique **labuser** catalog, and the default schema to **perf_opt**. All tables will be read from and written to this location.
# MAGIC <br></br>
# MAGIC
...
# MAGIC
# MAGIC 5. In the query plan, scroll down to the bottom and find **PhotonScan parquet labuser123.your schema.iot_data_partitioned (1)** and select the plus icon.
# MAGIC
# MAGIC
...
# MAGIC 4. Here you should see the entire query plan.
# MAGIC
# MAGIC 5. In the query plan, scroll down to the bottom and find **PhotonScan parquet labuser123.*your schema*.iot_data (1)** and select the plus icon.
# MAGIC
# MAGIC #### Look at the following metrics in the Spark UI (results may vary):
# MAGIC | Metric    | Value    | Note    |
# MAGIC |-------------|-------------|-------------|
