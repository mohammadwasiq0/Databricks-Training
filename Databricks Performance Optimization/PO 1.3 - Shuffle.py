...
# MAGIC
# MAGIC
# MAGIC To view the query DAG, complete the following steps:
# MAGIC
...
# MAGIC
# MAGIC 5. Then, select the number link in the table at the top under **Associated Job ID**. Next, click the number under **Associated SQL Query**. There, you will be able to see the entire query plan (DAG).
# MAGIC
...
# MAGIC <br></br>
# MAGIC ##### 6b. Shuffle Join of result with countries
# MAGIC
