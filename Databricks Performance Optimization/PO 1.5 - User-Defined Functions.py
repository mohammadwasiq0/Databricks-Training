...
# MAGIC %md
# MAGIC ### D2. Parallelizing a Python UDF through Repartitioning
# MAGIC
...
# MAGIC %md
# MAGIC #### Summary
# MAGIC The repartition command is a recommended best practice to ensure your UDF runs in a parallel, distributed manner.
...
# MAGIC %md
# MAGIC Explain the query plan with the SQL UDF. Notice that the SQL UDF is fully supported by Photon and is more performant.
