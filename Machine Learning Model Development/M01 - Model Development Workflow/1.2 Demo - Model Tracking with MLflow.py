...
# MAGIC
# MAGIC   **Option 1:**
# MAGIC   - Click the Experiment icon<img src= "../Includes/images/experiment.png" width=30>in the notebook’s right sidebar
# MAGIC
# MAGIC   - In the Experiment Runs sidebar, click the<img src= "../Includes/images/external-link.png" width=30>icon next to the date of the run. The MLflow Run page displays, showing details of the run, including parameters, metrics, tags, and a list of artifacts.
# MAGIC
# MAGIC     ![quick-start-nb-experiment](../Includes/images/quick-start-nb-experiment1.png)
# MAGIC
# MAGIC   **Option 2:**
...
# MAGIC   - You can find details about the logged model under the<img src= "../Includes/images/models-icon.png" width=30>**Models** tab.
